...
namespace HeckYeahGames
{
    namespace BulletHeck
    {
        namespace Patterns
        {
            namespace Shape
            {
                public class NSidedImplementation : IShapeImplementation
                {
                    public void Build(Vector3 worldPosition, ShapePattern shapePattern, ref ShapePoint[] shapePoints)
                    {
                        ...
                        MathHelper.GetPointsOnRadius(ref tempMajorPoints, worldPosition, shapePattern.maxRadius, 360.0f, 0.0f, false, true);
